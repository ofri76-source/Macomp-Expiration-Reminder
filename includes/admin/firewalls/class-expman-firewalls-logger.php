...
if ( ! class_exists( 'Expman_Firewalls_Logger' ) ) {
class Expman_Firewalls_Logger {

    public function log_firewall_event( $firewall_id, $action, $message = '', $context = array(), $level = 'info' ) {
        global $wpdb;
    ...
    public function format_log_value( $value, $type = 'text' ) {
        if ( $type === 'bool' ) {
